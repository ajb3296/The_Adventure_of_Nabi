...
PLAYERS_LIST =(
    'assets/sprites/originnabi-upflap.png',
    'assets/sprites/originnabi-midflap.png',
    'assets/sprites/originnabi-downflap.png',
)

# list of backgrounds
BACKGROUNDS_LIST = (
    'assets/sprites/background-kakasiy.png',
    'assets/sprites/background-yandere.png',
)
...
def main():
    ...
    pygame.display.set_caption('The Adventures of Nabi')
